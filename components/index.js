...
export const testAccessibility = async (document, cookie, output) => {
  ...
  funcRunner(checkInteractiveElementSize, document, undefined, output);
  funcRunner(checkAnimationFlash, undefined, undefined, output);
  funcRunner(checkReducedMotion, undefined, undefined, output);
};
