...
describe("Alt Text Component", () => {
  it("should detect missing alt text property", () => {
    ...
    expect(result1).to.include(chalk.red('Image without appropriate alt text:'));
  });
  ...
  it("should detect empty alt text property", () => {
    ...
    expect(result2).to.include(chalk.red('Image without appropriate alt text:'));
  });
  ...
  it('should fail because role="img" but no alt text detected', () => {
    ...
    expect(result3).to.include(chalk.red('Image without appropriate alt text:'));
  });
